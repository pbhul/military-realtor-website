...
export const metadata: Metadata = {
  ...
  description: "🎖️ MRP realtor and military relocation professional who has lived in Northern Virginia for 10+ years. Veterans real estate agent serving Fort Belvoir, Pentagon, Quantico. Military veteran real estate agents specializing in PCS relocations, VA loans, deployment management.",
  keywords: [
    ...
    "military veteran real estate agents near me", "relocation realtor", "veterans realtor",
    "military real estate agent", "military realtor", "military realtor near me",
    "va certified real estate agent", "real estate for veterans", "military real estate",
    ...
    "quantico marine realtor", "emergency PCS realtor", "tri-base military realtor",

    // Military Keywords - High Intent
    ...
    "deployment real estate management", "BAH optimization realtor northern virginia",
  ...
  openGraph: {
    title: "🎖️ Veterans Realtor Northern Virginia | MRP Certified Pentagon Area & Quantico Marine Realtor",
    description: "Veterans realtor Northern Virginia | MRP certified tri-base military realtor specializing in Pentagon area, Fort Belvoir & Quantico Marine relocations. Emergency PCS realtor services.",
    url: "https://www.pbrealtynova.com",
    siteName: "Veterans Realtor Northern Virginia - Military Real Estate",
    locale: "en_US",
    type: "website",
    images: [
      {
              ...
              "@graph": [
                {
                  ...
                  "description": "🎖️ MRP Certified military real estate specialist who has lived in Northern Virginia for 10+ years serving Fort Belvoir, Pentagon, and Quantico areas. Expert in PCS relocations, VA loans, BAH optimization for military families.",
                  "url": "https://www.pbrealtynova.com",
                  "sameAs": [
